...
Gem::Specification.new do |s|
  s.name = %q{tsenart-pivotal-tracker}
  s.version = "0.4.0"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = [%q{Justin Smestad}, %q{Josh Nichols}, %q{Terence Lee}, %q{Tomás Senart}]
  s.date = %q{2011-07-07}
  ...
  s.homepage = %q{http://github.com/tsenart/pivotal-tracker}
