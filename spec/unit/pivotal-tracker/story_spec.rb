...
describe PivotalTracker::Story do
  ...
  context ".create" do
    ...
    context "on failure" do
      before do
        FakeWeb.register_uri(:post, "#{PivotalTracker::API_URL}/projects/#{@project.id}/stories",
  ...
  context ".move_to_project" do
    let(:expected_uri) {"#{PivotalTracker::API_URL}/projects/#{project_id}/stories/#{story_id}"}
